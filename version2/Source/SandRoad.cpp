...
SandRoad::SandRoad(const SDL_FPoint& pos, const DeclinedTextureOrientation& orientation) :
DeclinedTexture(pos) {
	SDL_FRect tile;
	switch (orientation) {
		case DeclinedTextureOrientation::North: {
			tile = {3*S+2, 2, S-3, S-3};
			break;
		}
